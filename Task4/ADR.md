...
| UC3  | Система банка                    | Регулярно создавать и передавать партнерскому кол центру файл со ставками (при изменении ставок / раз в день)           |
...
1. Использование файла несет риски для безопасности
